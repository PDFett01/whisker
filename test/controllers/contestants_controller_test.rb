...
class ContestantsControllerTest < ActionController::TestCase
  ...
  test "should create contestant" do
    assert_difference('Contestant.count') do
      post :create, contestant: { city: @contestant.city, club: @contestant.club, competitions: @contestant.competitions, name: @contestant.name, style: @contestant.style }
    end
  ...
  test "should update contestant" do
    patch :update, id: @contestant, contestant: { city: @contestant.city, club: @contestant.club, competitions: @contestant.competitions, name: @contestant.name, style: @contestant.style }
    assert_redirected_to contestant_path(assigns(:contestant))
  end
